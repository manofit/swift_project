...
class RegisterViewController: GJBaseViewController, UITextFieldDelegate{
    ...
    func createUI(){
        ...
        personUserBtn?.setImage(UIImage(named:""), for: .normal)
        personUserBtn?.setImage(UIImage(named:""), for: .selected)
        ...
        companyUserBtn?.setImage(UIImage(named:""), for: .normal)
        companyUserBtn?.setImage(UIImage(named:""), for: .selected)
        ...
        getPicSmsBtn?.setImage(UIImage(named:""), for: .normal)
