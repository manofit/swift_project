//
//  CompanyInvestDetailViewController.swift
//  swift_project
//
...
class CompanyInvestDetailViewController: GJBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var cell:CompanyInvestDetailCell?
    var model:CompanyInvestDetailModel?
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cell = tableView.dequeueReusableCell(withIdentifier: "cellID") as? CompanyInvestDetailCell
