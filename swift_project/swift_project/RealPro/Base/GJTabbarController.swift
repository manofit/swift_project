...
class GJTabbarController: UITabBarController, UITabBarControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.addChildController(ChildController: MainViewController(), Title: "首页", DefaultImage: UIImage(named:"")!, SelectedImage: UIImage(named:"")!)
        self.addChildController(ChildController: InvestViewController(), Title: "出借", DefaultImage: UIImage(named:"")!, SelectedImage: UIImage(named:"")!)
        self.addChildController(ChildController: MineViewController(), Title: "我的账户", DefaultImage: UIImage(named:"")!, SelectedImage: UIImage(named:"")!)
